...
function prince2Template(): string {
	return [
		...
		"- Expected benefits:",
		"",
		"### Registers & initiation templates",
		"",
		"On create, PRINCE2 scaffolds lean Graph-linked notes under `Registers/` and `Initiation/`",
		"(Business Case, Risk / Issue & Change / Quality registers, Work Packages + template,",
		"Project Brief, PID, Stage Boundaries guide). Use Dashboard widgets to add register entries.",
		"",
		"### Work Packages",
		"",
		"- Duplicate `Work Package Template` when work is authorised.",
		"",
	].join("\n");
}
